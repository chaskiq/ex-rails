...
defmodule ActiveJob.QueuingTest do
  use ExUnit.Case
  doctest ActiveJob
  ...
  defp assert_job_executed(id = @id) do
    # assert job_executed(id), "Job #{id} was not executed"
  end

  defp assert_job_not_executed(id = @id) do
    # assert_not job_executed(id), "Job #{id} was executed"
  end

  defp assert_job_executed_before(first_id, second_id) do
