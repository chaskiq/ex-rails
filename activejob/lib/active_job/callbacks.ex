...
#
defmodule ActiveJob.Callbacks do
  ...
  #       #   end
  #       #
  def before_perform(filters, blk) do
  ...
  #       #   end
  #       #
  def after_perform(filters, blk) do
  ...
  #       #   end
  #       #
  def around_perform(filters, blk) do
  ...
  #       #   end
  #       #
  def before_enqueue(filters, blk) do
  ...
  #       #   end
  #       #
  def after_enqueue(filters, blk) do
  ...
  #       #   end
  #       #
  def around_enqueue(filters, blk) do
